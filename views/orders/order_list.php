...
<head>
    ...
    <style>
        ...
        .table-responsive {
            ...
            overflow-x: auto;
            background: #fff;
            box-shadow: inset 0 1px 3px rgba(0, 0, 0, 0); /* Subtle inner shadow */
        }
        ...
        .table thead th {
            background: linear-gradient(90deg, #f97316, #d97706); /* Warm orange gradient */
            color: white;
            border: none;
            padding: 20px 25px;
            font-weight: 700;
        ...
        .table tbody tr:hover {
            background-color: #f1f5f9; /* Softer hover color */
        }
        ...
        .table-striped tbody tr:nth-of-type(odd) {
            background-color: #f9fafb; /* Lighter odd-row color */
        }
        ...
        .rounded-circle {
            ...
            height: 50px;
            object-fit: cover;
            border: 3px solid #e5e7eb; /* Thicker, softer border */
            border-radius: 50%;
            margin-right: 15px;
            transition: all 0.3s ease;
        }
